...
class Welp(interface.implements(Game)):
  def __init__(self, bot):
    self.bot = bot
    self.name = constants.GAME_WELP
  ...
  def get_game_success_text(self):
    return 'Congratulations! You have passed this round. Enter "SCEPTER" in the survey link given below: \n\nLink : https://forms.gle/U1DvoKiErTguQBpZ9 \n\nPlease press the button and choose the next game :)'
